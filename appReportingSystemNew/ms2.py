...
class Template:
    ...
    def saveFormatTemplate(detailKolom, nama, posisi, tipe, lebar):
        ...
        for i in formatKolom:
            ...
            # posisiFooter = formatKolom['posisiFooter']
        ...
        try:
            ...
            # for a in range (len(kolomFooter)):
            #     try:
            #         cursor.execute(' INSERT INTO m_detailf VALUES (%s, %s, %s, %s)', (reportId, kolomFooter[i], "", ""))
            #         db.commit()
