...
class Template:
    ...
    def saveFormatTemplate(data):
        ...
        for i in loadData:
            ...
            rataTengah = loadData['rataTengah']
        ...
        try:
            ...
            for i in range (len(loadData)):
                try:
                    ...
                    cursor.execute('INSERT INTO m_detailh values (%s, %s, %s, %s, %s, %s, %s, %s)', (reportId,  namaKolom, posisiKolom, tipeKolom, lebarKolom, mergeKolom, rataTengah, rataKanan, rataKiri))
