...
def runSchedule(kode_laporan):
    ...
    if jmlHead == '1':
        ...
        try:
            ...
            workbook = xlsxwriter.Workbook('/appReportingSystem/Schedule/%s.xls'% (kode_laporan))
            ...
            requests.post('http://127.0.0.1:5004/updateReport/<kode_laporan>/')
...
def testPreviewLaporan(kode_laporan):
    ...
    if jmlHead == '1':
        try:
            ...
            workbook = xlsxwriter.Workbook('/appReportingSystem/ExcelFile/%s.xls'% (kode_laporan))
            worksheet = workbook.add_worksheet()
