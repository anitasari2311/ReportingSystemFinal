...
def spv():
    ...
    return render_template('ms2homeSPV.html', day= day, clock=clock)
...
def sendFormatTemplate():
    ...
    if request.method == 'POST':
        ...
        # for namaFooter in ['kolomFooter1', 'kolomFooter2']:
        #     if (request.form[namaFooter] is not None) and (request.form[namaFooter] is not ''):
        #         kolomFooter.append(request.form[namaFooter])
        #         kolomFooter1 = json.dumps(kolomFooter)
        # print(kolomFooter1)
        ...
        #         if posisiFooter == '':
        #             posisiFooter += request.form.get(posisiFooter)
        #         else:
        #             posisiFooter += ", "+request.form.get(posisiFooter)
