...
class Template:
    ...
    @app.route('/saveFormatTemplate/<detailKolom>/<nama>/<posisi>/<tipe>/<lebar>/<footer>',  methods = ['GET', 'POST'])
    def saveFormatTemplate(detailKolom, nama, posisi, tipe, lebar, footer):
        ...
        namaFooter = json.loads(footer)
        posisiFooter = json.loads(posisiF)
        ...
        try:
            ...
            for i in range (len(namaKolom)):
                try:
                    ...
                    cursor.execute(' INSERT INTO m_detailf VALUES (%s, %s, %s, %s)', (reportId, namaFooter[i], posisiFooter[i], ""))
                    db.commit()

                except Exception as e:
                   print(e)
            
            # for a in range (len(namaFooter)):
            #     try:
            #         cursor.execute(' INSERT INTO m_detailf VALUES (%s, %s, %s, %s)', (reportId, namaFooter[i], "", ""))
            #         db.commit()
